    ...
    return SingleChildScrollView(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text("Setting", style: TextStyle(fontSize: 30, fontWeight: FontWeight.w500)),
            SizedBox(height: 30),
            ListTile(
                leading: CircleAvatar(radius: 30, backgroundImage: AssetImage("assets/images/doctor1.jpg")),
            ...
            ListTile(
              ...
              leading: Container(
                  padding: EdgeInsets.all(10),
                  decoration: BoxDecoration(color: Colors.deepPurpleAccent.shade100, shape: BoxShape.circle),
